...
def update_facet_json_data():
    refresh_time =  timedelta(hours=1).total_seconds()
    categories_data, brands_data, countries_data = fetch_facet_json_data()
    ...
    cache.set("off_countries_cache", countries_data, timeout=refresh_time )
